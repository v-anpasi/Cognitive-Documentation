...
da-DK    |   Female  | "Microsoft Server Speech Text to Speech Voice (de-DE, HelleRUS)" 
...
es-MX|Female|"Microsoft Server Speech Text to Speech Voice (es-MX, LauraRUS)"
...
sv-SE|Male|"Microsoft Server Speech Text to Speech Voice (sv-SE, HedvigRUS)"
...
zh-TW|Male|"Microsoft Server Speech Text to Speech Voice (zh-TW, HanHanRUS)"
